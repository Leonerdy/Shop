        ...
        public async Task<IActionResult> Register(RegisterNewUserViewModel model)
        {
            if (this.ModelState.IsValid)
            {
                ...
                if (user == null)
                {
                    ...
                    this.mailHelper.SendMail(model.Username, "Shop Speed Service Email confirmation", $"<h1>Speed Service Email Confirmation</h1>" +
                        $"To allow the user, " +
                        $"Por favor click nesse link para confirmar email:</br></br><a href = \"{tokenLink}\">Confirm Email</a>");
                    this.ViewBag.Message = "As instruções para habilitar sua conta foram mandadas para seu email";
                    return this.View(model);
                }

                this.ModelState.AddModelError(string.Empty, "Esse Usuário já está registrado.");
            }
